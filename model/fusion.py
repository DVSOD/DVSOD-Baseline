...
class aggregation(nn.Module):
    ...
    def __init__(self, channel):
        ...
        self.conv4_2 = BasicConv2d(3 * channel, 2 * channel, 3, padding=1)
...
class fusion(nn.Module):
    ...
    def forward(self, x3_r,x4_r,x5_r,x3_d,x4_d,x5_d):
        ...
        x3 = self.SCA3(x3_r, x3_d)
        x4 = self.SCA4(x4_r, x4_d)
        x5 = self.SCA5(x5_r, x5_d)

        # Decoder
        x3_1 = self.rfb3_1(x3)
        x4_1 = self.rfb4_1(x4)
        x5_1 = self.rfb5_1(x5)
        attention_map, _ = self.agg1(x5_1, x4_1, x3_1)
        ...
        detection_map, fea = self.agg2(x5_2, x4_2, x3_2)

        return self.upsample(attention_map), self.upsample(detection_map), fea
