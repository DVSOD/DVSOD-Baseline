...
class aggregation(nn.Module):
    def __init__(self, channel):
        ...
        self.conv4_2 = nn.Conv2d(3 * channel, 2 * channel, 3, padding=1)
...
class CPD_VGG(nn.Module):
    def __init__(self, channel=32):
        ...
        self.vgg = B2_VGG(pre_trained=False)
    ...
    def forward(self, x):
        ...
        attention, _ = self.agg1(x5_1, x4_1, x3_1)
        ...
        detection, fea = self.agg2(x5_2, x4_2, x3_2)

        return self.upsample(attention), self.upsample(detection), fea
